package com.pms.ud4_serviciodescargasinhilos_02;
...
public class MyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // No re-crea el servicio iniciado si lo finaliza por falta de memoria
    ...
    private int DownloadFile(URL url) {
        try {
            // simula el tiempo requerido para descarga---OBSERVA  QUE BLOQUEA UI
            Thread.sleep(50000);
