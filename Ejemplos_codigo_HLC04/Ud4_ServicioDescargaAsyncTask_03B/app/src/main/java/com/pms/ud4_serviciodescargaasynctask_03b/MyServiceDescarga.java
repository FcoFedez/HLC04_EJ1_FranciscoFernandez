package com.pms.ud4_serviciodescargaasynctask_03b;
...
public class MyServiceDescarga extends Service {
    public MyServiceDescarga() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(enEjecucion()==false) {
            ...
            Toast.makeText(getBaseContext(),
                    "No puedes volver a descargar, ya está descargando", Toast.LENGTH_LONG).show();
    ...
    private int DownloadFile(URL url) {
        try {
            // ---simula el timepo necesario para la descarga de un archivo
            //durmiendo el hilo
            Thread.sleep(2000);
    ...
    private class DoBackgroundTask extends AsyncTask<URL, Integer, Long> {
        ...
        protected void onCancelled() {
            ...
            descargaTask = null;
            Toast.makeText(getBaseContext(),
                    "Cancelado el hilo secundario", Toast.LENGTH_LONG)
                    .show();
        }
    }
